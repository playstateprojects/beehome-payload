...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  await db.run(sql`CREATE TABLE \`checklist_option_groups_options\` (
  	\`_order\` integer NOT NULL,
  ...
  await db.run(sql`CREATE TABLE \`checklist_option_groups_options_locales\` (
  	\`description\` text,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`_locale\` text NOT NULL,
  	\`_parent_id\` text NOT NULL,
  ...
  await db.run(sql`CREATE TABLE \`checklist_option_groups\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  ...
  await db.run(sql`CREATE TABLE \`checklist_option_groups_locales\` (
  	\`title\` text,
  	\`description\` text,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`_locale\` text NOT NULL,
  ...
  await db.run(sql`CREATE TABLE \`checklist_end_screens\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`image_id\` integer,
  ...
  await db.run(sql`CREATE TABLE \`checklist_end_screens_locales\` (
  	\`title\` text NOT NULL,
  	\`action_button\` text,
  	\`body\` text,
  	\`id\` integer PRIMARY KEY NOT NULL,
  ...
  await db.run(sql`CREATE TABLE \`checklist_locales\` (
  	\`title\` text NOT NULL,
  	\`description\` text,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`_locale\` text NOT NULL,
